...
(function() {
  ...
  adapter.prototype = {
    ...
    load : function ( path ) {
      ...
      req.addEventListener( "progress", function ( event ) { _this._updateProgress.call( _this, event ); }, false );
...
(function() {
  ...
  adapter.prototype = {
    ...
    load : function ( path ) {
      ...
      this.audio.addEventListener( 'progress', function ( event ) { _this._updateProgress.call( _this, event ); }, false );
    ...
    _updateProgress : function (e) {
      if(e.currentTarget.seekable.length) {
